...
def create_model():
    model = keras.Sequential([
        layers.Conv2D(60, (5, 5), input_shape=(32, 32, 1), activation='relu'),
...
while True:
        ...
        if probabilityValue > threshold:
            cv2.putText(imgOrignal, str(classIndex[0])+" "+str(getCalssName(classIndex[0])), (120, 35), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
